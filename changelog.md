...
## [3.0.0-preview.4](https://github.com/unity-game-framework/ugf-module-assetbundles/releases/tag/3.0.0-preview.4) - 2024-08-14  

### Release Notes

- [Milestone](https://github.com/unity-game-framework/ugf-module-assetbundles/milestone/25?closed=1)  
    

### Changed

- Update package ([#69](https://github.com/unity-game-framework/ugf-module-assetbundles/issues/69))  
    - Update dependencies: `com.ugf.module.assets` to `6.0.0-preview.2` and `com.ugf.module.scenes` to `5.0.0-preview` versions.
    - Change `AssetBundleModule` and related classes to support updated _Application_ package.

## [3.0.0-preview.2](https://github.com/unity-game-framework/ugf-module-assetbundles/releases/tag/3.0.0-preview.2) - 2024-05-19  

### Release Notes

- [Milestone](https://github.com/unity-game-framework/ugf-module-assetbundles/milestone/24?closed=1)  
    

### Added

- Add asset bundle build asset preview tabs ([#66](https://github.com/unity-game-framework/ugf-module-assetbundles/issues/66))  
    - Add `AssetBundleBuildAsset` inspector display of selected asset as well as bundle information preview.
...
- [Milestone](https://github.com/unity-game-framework/ugf-module-assetbundles/milestone/20?closed=1)  
    

### Changed

- Update project ([#56](https://github.com/unity-game-framework/ugf-module-assetbundles/issues/56))  
    - Update dependencies: `com.ugf.module.assets` to `5.0.0` and `com.ugf.module.scenes` to `4.0.0` versions.
    - Add `AssetBundleAsset` class default inspector implementation.
    - Add `AssetBundleFileAsset` class inspector selection preview support for `Dependencies` property.
    - Add `AssetBundleGroupAsset` class inspector selection preview support for `Groups` property.
